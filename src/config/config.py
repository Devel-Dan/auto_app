...
SELECTORS = {
    ...
    "PAGINATION": ".jobs-search-pagination",  # Changed from .jobs-search-results-list__pagination
    "ACTIVE_PAGE": ".jobs-search-pagination__indicator-button--active",  # Changed from .artdeco-pagination__indicator--number.active
    "PAGE_STATE": ".jobs-search-pagination__page-state",  # Add this new selector
    "NEXT_BUTTON": ".jobs-search-pagination__button--next",  # Add this new selector
    "NAVIGATION": {
...
6. Ensure each professional experience contains at least one acheivement that can be related to what the job description is looking for, if not, generate an additional achievement, it needs to make sense to that experience as well.
6.a If you have to generate an additional acheivement, DO NOT mention "job description" or the current job I am applying for!!!! It can't appear to have been generated by an AI.
...
16. DO NOT ADD any additional Professional Experiences
""",
